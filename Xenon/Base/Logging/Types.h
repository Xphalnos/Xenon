...
enum class Level : u8 {
  Trace, ///< Extremely detailed and repetitive debugging information that is
         ///< likely to
  ///< pollute logs.
  Debug,   ///< Less detailed debugging information.
  Info,    ///< Status information from important points during execution.
  Warning, ///< Minor or potential problems found during execution of a task.
  Error,   ///< Major problems found during execution of a task that prevent it
         ///< from being completed.
  Critical, ///< Major problems during execution that threaten the stability of
 ...
 *
 * @note If you add a new entry here, also add a corresponding one to
 * `ALL_LOG_CLASSES` in filter.cpp.
 */
enum class Class : u8 {
