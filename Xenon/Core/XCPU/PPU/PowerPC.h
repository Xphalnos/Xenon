 ...
 * original copyright. Modifed for usage in the Xenon Emulator All rights
 * reserved License: GPL2
 */
...
union PPCOpcode {
  ...
  ControlField<PPCBitfield<u32, 30, 1>, PPCBitfield<u32, 16, 5>>
      sh64; // 30 + 16..20
  ControlField<PPCBitfield<u32, 26, 1>, PPCBitfield<u32, 21, 5>>
      mbe64;                       // 26 + 21..25
...
struct PPU_STATE_SPRS {
  ...
  u64 HRMOR;
  // Logical Partition Control Register (This register has partially shared
  // fields)
  // FIXME!
  u64 LPCR;
